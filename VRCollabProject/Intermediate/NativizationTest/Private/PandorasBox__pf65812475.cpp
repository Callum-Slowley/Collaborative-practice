#include "VRCollabProject.h"
#include "PandorasBox__pf65812475.h"
...
APandorasBox_C__pf65812475::APandorasBox_C__pf65812475(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APandorasBox_C__pf65812475::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APandorasBox_C__pf65812475::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__3 = ECollisionChannel::ECC_GameTraceChannel1;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__5.AddUninitialized(7);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__5.GetData(), 7);
	...
	__Local__12.Channel = FName(TEXT("Handle"));
	...
	auto& __Local__13 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__13 = FVector(2.000000, 2.000000, 2.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Box__pf), true, 0));
	bpv__TeleportArrays__pf = TArray<FVector> ();
	bpv__ArrayIndex__pf = 0;
...
void APandorasBox_C__pf65812475::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APandorasBox_C__pf65812475::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APandorasBox_C__pf65812475::bpf__ExecuteUbergraph_PandorasBox__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				FCustomThunkTemplates::Array_Get(bpv__TeleportArrays__pf, bpv__ArrayIndex__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_K2_TeleportTo_ReturnValue__pf = AActor::K2_TeleportTo(b0l__CallFunc_Array_Get_Item__pf, FRotator(0.000000,0.000000,0.000000));
			}
		case 3:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__TeleportArrays__pf);
				...
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(bpv__ArrayIndex__pf, bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf);
		...
		case 9:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__ArrayIndex__pf, 1);
				b0l__Temp_int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 10:
			{
				bpv__ArrayIndex__pf = b0l__Temp_int_Variable__pf;
			}
		case 11:
			{
			}
...
void APandorasBox_C__pf65812475::bpf__ExecuteUbergraph_PandorasBox__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 13);
	return; // KCST_GotoReturn
}
void APandorasBox_C__pf65812475::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PandorasBox__pf_0(1);
}
void APandorasBox_C__pf65812475::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_PandorasBox__pf_1(13);
}
PRAGMA_DISABLE_OPTIMIZATION
void APandorasBox_C__pf65812475::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APandorasBox_C__pf65812475::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{2, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SceneComponent 
		...
		{4, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.BoxComponent 
		{5, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/NavigationSystem.NavArea_Obstacle 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APandorasBox_C__pf65812475
{
	FRegisterHelper__APandorasBox_C__pf65812475()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/CallumTests/Ai_blueprints/PandorasBox"), &APandorasBox_C__pf65812475::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APandorasBox_C__pf65812475 Instance;
};
FRegisterHelper__APandorasBox_C__pf65812475 FRegisterHelper__APandorasBox_C__pf65812475::Instance;
