...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AVRPlayerPawn_Statics::NewProp_rootSceneComponent_MetaData[] = {
		{ "Category", "VRPlayerPawn" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "VRPlayerPawn.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AVRPlayerPawn_Statics::NewProp_rootSceneComponent = { "rootSceneComponent", nullptr, (EPropertyFlags)0x00200800000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AVRPlayerPawn, rootSceneComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AVRPlayerPawn_Statics::NewProp_rootSceneComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AVRPlayerPawn_Statics::NewProp_rootSceneComponent_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AVRPlayerPawn_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AVRPlayerPawn_Statics::NewProp_rootSceneComponent,
	...
	IMPLEMENT_CLASS(AVRPlayerPawn, 2520632897);
